<x-app-layout :title="'Product Show'">
    @push('style')
                                ...
                                <div class="swiper product-thumbnail-slider p-2 rounded bg-light">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <img src="{{asset('public/backend')}}/images/products/img-8.png" alt="" class="img-fluid d-block" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{asset('public/backend')}}/images/products/img-6.png" alt="" class="img-fluid d-block" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{asset('public/backend')}}/images/products/img-1.png" alt="" class="img-fluid d-block" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{asset('public/backend')}}/images/products/img-8.png" alt="" class="img-fluid d-block" />
                                        </div>
                                                            ...
                                                            <div class="border border-dashed rounded p-3">
                                                                ...
                                                                <div class="d-flex flex-grow-1 gap-2 mb-3">
                                                                    <a href="#" class="d-block">
                                                                        <img src="{{asset('public/backend')}}/images/small/img-12.jpg" alt="" class="avatar-sm rounded object-fit-cover material-shadow">
                                                                    </a>
                                                                    <a href="#" class="d-block">
                                                                        <img src="{{asset('public/backend')}}/images/small/img-11.jpg" alt="" class="avatar-sm rounded object-fit-cover material-shadow">
                                                                    </a>
                                                                    <a href="#" class="d-block">
                                                                        <img src="{{asset('public/backend')}}/images/small/img-10.jpg" alt="" class="avatar-sm rounded object-fit-cover material-shadow">
                                                                    </a>
                                                                </div>
