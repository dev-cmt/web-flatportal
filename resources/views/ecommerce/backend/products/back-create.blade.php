<x-app-layout :title="'Products List'">
    @push('style')
        <!-- Plugins css -->
        <link href="{{asset('public/backend')}}/libs/dropzone/dropzone.css" rel="stylesheet" type="text/css" />
    @endpush
    ...
    @push('scripts')
        <!-- ckeditor -->
        <script src="{{asset('public/backend')}}/libs/%40ckeditor/ckeditor5-build-classic/build/ckeditor.js"></script>

        <!-- dropzone js -->
        <script src="{{asset('public/backend')}}/libs/dropzone/dropzone-min.js"></script>

        <script src="{{asset('public/backend')}}/js/pages/ecommerce-product-create.init.js"></script>
    @endpush
</x-app-layout>