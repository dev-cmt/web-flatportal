<x-frontend-layout :title="'Coupon'">
                    ...
                    <div class="tp-coupon-item mb-30 p-relative d-md-flex justify-content-between align-items-center">
                        ...
                        <div class="tp-coupon-item-left d-sm-flex align-items-center">
                            <div class="tp-coupon-thumb">
                                <a href="#">
                                    <img alt="logo" src="{{asset('public/frontend')}}/img/product/2/prodcut-1.jpg">
                                </a>
                            </div>
                            ...
                            <div class="tp-coupon-status mb-10 d-flex align-items-center">
                                ...
                                <div class="tp-coupon-info-details">
                                    ...
                                    <div class="tp-coupon-info-tooltip transition-3">
                                        <p>*This coupon code will apply on <span>Grocery type products</span> and when you
                                            shopping more than <span>$500</span></p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-xl-6">
                    <div class="tp-coupon-item mb-30 p-relative d-md-flex justify-content-between align-items-center">
                        ...
                        <div class="tp-coupon-item-left d-sm-flex align-items-center">
                            <div class="tp-coupon-thumb">
                                <a href="#">
                                    <img alt="logo" src="{{asset('public/frontend')}}/img/product/2/prodcut-2.jpg">
                                </a>
                            </div>
                            <div class="tp-coupon-content">
                ...
                <div class="col-xl-6">
                    <div class="tp-coupon-item mb-30 p-relative d-md-flex justify-content-between align-items-center">
                        ...
                        <div class="tp-coupon-item-left d-sm-flex align-items-center">
                            <div class="tp-coupon-thumb">
                                <a href="#">
                                    <img alt="logo" src="{{asset('public/frontend')}}/img/product/2/prodcut-3.jpg">
                                </a>
                            </div>
                            <div class="tp-coupon-content">
                ...
                <div class="col-xl-6">
                    <div class="tp-coupon-item mb-30 p-relative d-md-flex justify-content-between align-items-center">
                        ...
                        <div class="tp-coupon-item-left d-sm-flex align-items-center">
                            <div class="tp-coupon-thumb">
                                <a href="#">
                                    <img alt="logo" src="{{asset('public/frontend')}}/img/product/2/prodcut-4.jpg">
                                </a>
                            </div>
                            <div class="tp-coupon-content">
                ...
                <div class="col-xl-6">
                    <div class="tp-coupon-item mb-30 p-relative d-md-flex justify-content-between align-items-center">
                        ...
                        <div class="tp-coupon-item-left d-sm-flex align-items-center">
                            <div class="tp-coupon-thumb">
                                <a href="#">
                                    <img alt="logo" src="{{asset('public/frontend')}}/img/product/2/prodcut-5.jpg">
                                </a>
                            </div>
                            <div class="tp-coupon-content">
                ...
                <div class="col-xl-6">
                    <div class="tp-coupon-item mb-30 p-relative d-md-flex justify-content-between align-items-center">
                        ...
                        <div class="tp-coupon-item-left d-sm-flex align-items-center">
                            <div class="tp-coupon-thumb">
                                <a href="#">
                                    <img alt="logo" src="{{asset('public/frontend')}}/img/product/2/prodcut-6.jpg">
                                </a>
                            </div>
                            <div class="tp-coupon-content">
