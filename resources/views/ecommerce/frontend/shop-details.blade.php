<x-frontend-layout :title="'Products List'">
    ...
    <section class="tp-product-details-area">
        <div class="tp-product-details-top pb-40">
            <div class="container">
                <div class="row">
                        ...
                        <div class="tp-product-details-thumb-slider p-relative">
                            <div class="tp-product-details-thumb-slider-active swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    {{-- <div class="tp-prouct-details-thumb-item w-img swiper-slide">
                                        <img src="{{asset('public/frontend')}}/img/product/details/slider/product-details-slider-1.jpg" alt="">
                                    </div>
                                    <div class="tp-prouct-details-thumb-item w-img swiper-slide">
                                        <img src="{{asset('public/frontend')}}/img/product/details/slider/product-details-slider-2.jpg" alt="">
                                    </div>
                                    <div class="tp-prouct-details-thumb-item w-img swiper-slide">
                                        <img src="{{asset('public/frontend')}}/img/product/details/slider/product-details-slider-3.jpg" alt="">
                                    </div>
                                    <div class="tp-prouct-details-thumb-item w-img swiper-slide">
                                        <img src="{{asset('public/frontend')}}/img/product/details/slider/product-details-slider-4.jpg" alt="">
                                    </div>
                                    <div class="tp-prouct-details-thumb-item w-img swiper-slide">
                                        <img src="{{asset('public/frontend')}}/img/product/details/slider/product-details-slider-5.jpg" alt="">
                                    </div>
                                    <div class="tp-prouct-details-thumb-item w-img swiper-slide">
                                        <img src="{{asset('public/frontend')}}/img/product/details/slider/product-details-slider-6.jpg" alt="">
                                    </div> --}}
                                </div>
                            </div>
                    ...
                    <div class="col-xl-5 col-lg-6">
                        <div class="tp-product-details-wrapper">
                            ...
                            <h3 class="tp-product-details-title">{{$data->product_name}}</h3>
                            ...
                            <div class="tp-product-details-price-wrapper mb-20">
                                <span class="tp-product-details-price old-price">{{ $data->price }} ৳</span>
                                <span class="tp-product-details-price new-price">{{ round($data->price - ($data->price * $data->discount / 100)) }} ৳</span>
                            </div>
                                        ...
                                        @foreach ($data->variants as $item)
                                            @if (!empty($item->color->color_name))
                                                <button type="button" class="color tp-color-variation-btn" >
                                                    <span data-bg-color="{{$item->color->color_name}}"></span>
                                                    <span class="tp-color-variation-tootltip">{{$item->color->color_name}}</span>
                                                </button>
                                            @endif
                                        @endforeach
                                    </div>
                            ...
                            @php
                                $url = urlencode(route('shop-details', ['id' => $data->id, 'url_slug' => $data->url_slug]));
                                $name = urlencode($data->product_name);
                            @endphp

                            <div class="tp-product-details-social">
                                <span>Share: </span>
                                <a href="https://www.facebook.com/sharer/sharer.php?u={{ $url }}" target="_blank"><i class="fa-brands fa-facebook-f"></i></a>
                                <a href="https://twitter.com/intent/tweet?url={{ $url }}&text={{ $name }}" target="_blank"><i class="fa-brands fa-twitter"></i></a>
                                <a href="https://www.linkedin.com/shareArticle?mini=true&url={{ $url }}&title={{ $name }}" target="_blank"><i class="fa-brands fa-linkedin-in"></i></a>
                                <a href="https://vimeo.com?url={{ $url }}" target="_blank"><i class="fa-brands fa-vimeo-v"></i></a>
                            </div>
                            ...
                            <div
                                ...
                                <img src="{{asset('public/frontend')}}/img/product/icons/payment-option.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="tp-product-details-bottom pb-40">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="tp-product-details-tab-nav tp-tab">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade" id="nav-description" role="tabpanel" aria-labelledby="nav-description-tab" tabindex="0">
                                    ...
                                    <div class="tp-product-details-desc-wrapper pt-30">
                                        {!! $data->description !!}
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="tp-product-details-review-statics">
                                                    <!-- number -->
                                                    <div class="tp-product-details-review-number d-inline-block mb-40">
                                                        ...
                                                        <div class="tp-product-details-review-summery d-flex align-items-center">
                                                            <div class="tp-product-details-review-summery-value">
                                                                <!-- Average Rating -->
                                                                <span>{{ number_format($data->reviews->avg('rating'), 1) }}</span>
                                                            </div>
                                                            <div class="tp-product-details-review-summery-rating d-flex align-items-center">
                                                                ...
                                                                @for ($i = 0; $i < 5; $i++)
                                                                    <span><i class="fa-solid fa-star"></i></span>
                                                                @endfor
                                                                <p>({{ $data->reviews->count() }} Reviews)</p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="tp-product-details-review-rating-list">
                                                            @php
                                                                ...
                                                                $ratingCounts = $data->reviews->groupBy('rating')->map->count();
                                                            ...
                                                            @for ($i = 5; $i >= 1; $i--)
                                                                ...
                                                                <div class="tp-product-details-review-rating-item d-flex align-items-center">
                                                                    ...
                                                                    <div class="tp-product-details-review-rating-bar">
                                                                        <span class="tp-product-details-review-rating-bar-inner" style="width: {{ number_format($percentage, 1) }}%;"></span>
                                                                    </div>
                                                    ...
                                                    <!-- reviews -->
                                                    <div class="tp-product-details-review-list pr-50">
                                                        <h3 class="tp-product-details-review-title">Rating & Review</h3>

                                                        <div id="review-container">
                                                            @foreach ($data->reviews->take(3) as $review)
                                                            <div class="tp-product-details-review-avater d-flex align-items-start">
                                                                <div class="tp-product-details-review-avater-thumb">
                                                                    <a href="#">
                                                                        <img src="{{ asset('public/frontend/img/users/user-2.jpg') }}" alt="">
                                                                    </a>
                                                                </div>
                                                                <div class="tp-product-details-review-avater-content">
                                                                    <div class="tp-product-details-review-avater-rating d-flex align-items-center">
                                                                        ...
                                                                        @for ($i = 0; $i < 5; $i++)
                                                                            <span><i class="fa-solid fa-star{{ $i < $review->rating ? '' : '-o' }}"></i></span>
                                                                        @endfor
                                                                    </div>
                                                        ...
                                                        @if ($data->reviews->count() > 3)
                                                            <h6 class="text-center text-primary" id="show-more" data-page="1" style="cursor: pointer;text-decoration: underline;">Show More</h6>
                                                        @endif
                                                    </div>
                                                    @push('scripts')
                                                    <script>
                                                        $(document).ready(function() {
                                                            $('#show-more').on('click', function() {
                                                                ...
                                                                page++;  // Increment page number to load the next set of reviews

                                                                $.ajax({
                                                                    url: "{{ route('load-more-reviews') }}",  // Replace with your route name
                                                                    method: 'GET',
                                                                    data: { 
                                                                        page: page, 
                                                                        product_id: {{ $data->id }}  // Pass product ID if needed
                                                                    },
                                                                    success: function(response) {
                                                                        if (response.reviews.length > 0) {
                                                                                ...
                                                                                $('#review-container').append(`
                                                                                    <div class="tp-product-details-review-avater d-flex align-items-start">
                                                                                        ...
                                                                                        <div class="tp-product-details-review-avater-content">
                                                                                            ...
                                                                                            <h3 class="tp-product-details-review-avater-title">${review.user_name}</h3>
                                                                                            <span class="tp-product-details-review-avater-meta">${review.created_at}</span>
                                                                                            <div class="tp-product-details-review-avater-comment">
                                                                                                <p>${review.review}</p>
                                                                                            </div>
                                                                                        </div>
                                                                            ...
                                                                            // Increment the page number in the button's data-page attribute
                                                                            $('#show-more').data('page', page);
                                                    ...
                                                    <form action="{{ route('product.review.store') }}" method="POST">
                                                        ...
                                                        <div class="tp-product-details-review-form-rating d-flex align-items-center">
                                                            ...
                                                            <div class="tp-product-details-review-form-rating-icon d-flex align-items-center">
                                                                @for ($i = 1; $i <= 5; $i++)
                                                                    <span class="star{{ $i <= old('rating', 5) ? ' filled' : '' }}" data-rating="{{ $i }}" style="cursor: pointer;">
                                                        ...
                                                        <div class="tp-product-details-review-input-wrapper">
                                                            <div class="tp-product-details-review-input-box">
                                                                <div class="tp-product-details-review-input">
                                                                    <textarea id="msg" name="review" placeholder="Write your review here...">{{ old('review') ?? 'Thanks!!!' }} </textarea>
                                                                </div>
                                                                @error('review')
                                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                                @enderror
                                                            ...
                                                            <div class="tp-product-details-review-input-box">
                                                                <div class="tp-product-details-review-input">
                                                                    <input name="name" id="name" type="text" placeholder="Shahnewaz Sakil" value="{{ old('name', auth()->user()->name ?? '') }}">
                                                                </div>
                                                                @error('name')
                                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                                @enderror
                                                            ...
                                                            <div class="tp-product-details-review-input-box">
                                                                <div class="tp-product-details-review-input">
                                                                    <input name="email" id="email" type="email" placeholder="shofy@mail.com" value="{{ old('email', auth()->user()->email ?? '') }}">
                                                                </div>
                                                                @error('email')
                                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                                @enderror
    ...
    <section class="tp-related-product pt-40 pb-40">
        <div class="container">
            <div class="row">
                        ...
                        <div class="swiper-wrapper">
                                ...
                                <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                    <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                        <a href="product-details.html">
                                            <img src="{{asset('public/frontend')}}/img/product/related/product-related-1.jpg" alt="">
                                        </a>
                            ...
                            <div class="swiper-slide">
                                <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                    <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                        <a href="product-details.html">
                                            <img src="{{asset('public/frontend')}}/img/product/related/product-related-2.jpg" alt="">
                                        </a>
                            ...
                            <div class="swiper-slide">
                                <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                    <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                        <a href="product-details.html">
                                            <img src="{{asset('public/frontend')}}/img/product/related/product-related-3.jpg" alt="">
                                        </a>
                            ...
                            <div class="swiper-slide">
                                <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                    <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                        <a href="product-details.html">
                                            <img src="{{asset('public/frontend')}}/img/product/related/product-related-4.jpg" alt="">
                                        </a>
