                            ...
                            <div class="tp-login-social mb-10 d-flex flex-wrap align-items-center justify-content-center">
                                <div class="tp-login-option-item has-google">
                                    <a href="{{ route('social.login', 'google') }}">
                                        <img src="{{asset('public/frontend')}}/img/icon/login/google.svg" alt=""> Sign in with google
                                    </a>
                                </div>
                                <div class="tp-login-option-item">
                                    <a href="{{ route('social.login', 'facebook') }}">
                                        <img src="{{asset('public/frontend')}}/img/icon/login/facebook.svg" alt="">
                                    </a>
                                </div>
                                {{-- <div class="tp-login-option-item">
                                    <a href="#">
                                        <img class="apple" src="{{asset('public/frontend')}}/img/icon/login/apple.svg" alt="">
                                    </a>
                                </div> --}}
                            </div>
                                ...
                                <div class="tp-login-input-wrapper">
                                    <div class="tp-login-input-box">
                                        <div class="tp-login-input">
                                            <input type="text" name="name" value="{{old('name')}}" required autofocus autocomplete="name" id="name" placeholder="Enter name">
                                    ...
                                    <div class="tp-login-input-box">
                                        <div class="tp-login-input">
                                            <input type="email" name="email" value="{{old('email')}}" required autofocus autocomplete="email" id="email" placeholder="Enter email">
                                    ...
                                    <div class="tp-login-input-box">
                                        <div class="tp-login-input">
                                            <input type="password" name="password" id="tp_password" onpaste="return false" placeholder="Min. 6 character" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" autocomplete="new-password">
