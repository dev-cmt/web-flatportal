        ...
        <div class="container">
            <div class="profile__inner p-relative">
                <div class="profile__shape">
                    <img class="profile__shape-1" src="{{asset('public/frontend')}}/img/login/laptop.png" alt="" >
                    <img class="profile__shape-2" src="{{asset('public/frontend')}}/img/login/man.png" alt="" >
                    <img class="profile__shape-3" src="{{asset('public/frontend')}}/img/login/shape-1.png" alt="" >
                    <img class="profile__shape-4" src="{{asset('public/frontend')}}/img/login/shape-2.png" alt="" >
                    <img class="profile__shape-5" src="{{asset('public/frontend')}}/img/login/shape-3.png" alt="" >
                    <img class="profile__shape-6" src="{{asset('public/frontend')}}/img/login/shape-4.png" alt="" >
                </div>
                <div class="row">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-6">
                                            <div class="profile__main-inner d-flex flex-wrap align-items-center">
                                                ...
                                                <img src="{{asset('public/frontend')}}/img/users/user-10.jpg" alt="">
