<x-frontend-layout :title="'Products List'">
    ...
    <section class="breadcrumb__area include-bg pt-40 pb-40">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-4">
                    <div class="tp-shop-sidebar mr-10">
                                        ...
                                        @foreach ($categories as $category)
                                            <li>
                                                <div class="tp-shop-widget-checkbox-circle">
                                                    <input type="checkbox" class="category-filter" id="category-{{ $category->id }}" data-id="{{ $category->id }}">
                                                    <label for="category-{{ $category->id }}">{{ $category->category_name }}</label>
                                                    <span style="background: #0989ff; border-radius: 0%;" class="tp-shop-widget-checkbox-circle-self"></span>
                                                </div>
                                                <span class="tp-shop-widget-checkbox-circle-number">{{ $category->products->count() }}</span>
                                            </li>
                                        @endforeach
                                    </ul>
                                </div>
                        ...
                        <script>
                            ...
                            // Initialize the filters from URL on page load
                            function initializeFilters() {
                                ...
                                Object.keys(queryParams).forEach(function (param) {
                                    if (param.startsWith('colors[')) {
                                        var colorId = queryParams[param];
                                        $("#color-" + colorId).prop("checked", true);
                                    }
                                });
                            }
                            ...
                            // Bind pagination links with AJAX
                            function bindPaginationLinks() {
                                $(document).on('click', '.pagination a', function (e) {
                                    ...
                                    filterProducts(page);  // Fetch the products for the clicked page
                                });
                            }
                            ...
                            function filterProducts(page = 1) {
                                ...
                                $.ajax({
                                    ...
                                    success: function (data) {
                                        $('#products-container').html(data);  // Update the product list with the new content
                                        bindPaginationLinks();  // Rebind pagination links after the content is loaded
                                    },
                                        ...
                                        <div class="tp-shop-widget-product-item d-flex align-items-center">
                                            <div class="tp-shop-widget-product-thumb">
                                                <a href="product-details.html">
                                                    <img src="{{asset('public/frontend')}}/img/product/shop/sm/shop-sm-1.jpg" alt="">
                                                </a>
                                            </div>
                ...
                <div class="col-xl-9 col-lg-8">
                    <div class="tp-shop-main-wrapper">
                        ...
                        <!-- Include the partial view for the product list -->
                        @include('ecommerce.frontend.partials.product-list', ['products' => $products])
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <nav>
                            <div class="nav nav-tabs flex-sm-column " id="productDetailsNavThumb" role="tablist">
                                <button class="nav-link active" id="nav-1-tab" data-bs-toggle="tab"
                                    ...
                                    aria-selected="true">
                                    <img src="{{asset('public/frontend')}}/img/product/details/nav/product-details-nav-1.jpg"
                                        alt="">
                                </button>
                                <button class="nav-link" id="nav-2-tab" data-bs-toggle="tab" data-bs-target="#nav-2"
                                    ...
                                    <img src="{{asset('public/frontend')}}/img/product/details/nav/product-details-nav-2.jpg"
                                        alt="">
                                </button>
                                <button class="nav-link" id="nav-3-tab" data-bs-toggle="tab" data-bs-target="#nav-3"
                                    ...
                                    <img src="{{asset('public/frontend')}}/img/product/details/nav/product-details-nav-3.jpg"
                                        alt="">
                                </button>
                                <button class="nav-link" id="nav-4-tab" data-bs-toggle="tab" data-bs-target="#nav-4"
                                    ...
                                    <img src="{{asset('public/frontend')}}/img/product/details/nav/product-details-nav-4.jpg"
                                        alt="">
                                </button>
                            </div>
                        </nav>
                        <div class="tab-content m-img" id="productDetailsNavContent">
                            <div class="tab-pane fade show active" id="nav-1" role="tabpanel"
                                ...
                                <div class="tp-product-details-nav-main-thumb">
                                    <img src="{{asset('public/frontend')}}/img/product/details/main/product-details-main-1.jpg"
                                        alt="">
                                </div>
                            </div>
                            <div class="tab-pane fade" id="nav-2" role="tabpanel" aria-labelledby="nav-2-tab"
                                tabindex="0">
                                <div class="tp-product-details-nav-main-thumb">
                                    <img src="{{asset('public/frontend')}}/img/product/details/main/product-details-main-2.jpg"
                                        alt="">
                                </div>
                            </div>
                            <div class="tab-pane fade" id="nav-3" role="tabpanel" aria-labelledby="nav-3-tab"
                                tabindex="0">
                                <div class="tp-product-details-nav-main-thumb">
                                    <img src="{{asset('public/frontend')}}/img/product/details/main/product-details-main-3.jpg"
                                        alt="">
                                </div>
                            </div>
                            <div class="tab-pane fade" id="nav-4" role="tabpanel" aria-labelledby="nav-4-tab"
                                tabindex="0">
                                <div class="tp-product-details-nav-main-thumb">
                                    <img src="{{asset('public/frontend')}}/img/product/details/main/product-details-main-4.jpg"
                                        alt="">
                                </div>
                            </div>
                        </div>
