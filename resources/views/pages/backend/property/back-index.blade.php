<x-app-layout :title="'Products List'">
    ...
    @endpush
    @push('scripts')
        <!-- nouisliderribute js (ecommerce)-->
        <script src="{{asset('public/backend')}}/libs/nouislider/nouislider.min.js"></script>
        <script src="{{asset('public/backend')}}/libs/wnumb/wNumb.min.js"></script>
        <!-- gridjs js (ecommerce)-->
        <script src="{{asset('public/backend')}}/libs/gridjs/gridjs.umd.js"></script>
        <!-- product list (ecommerce)-->
        <script src="{{asset('public/backend')}}/js/pages/ecommerce-product-list.init.js"></script>
    @endpush
