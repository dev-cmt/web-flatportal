<x-frontend-layout :title="'Blog Details'">
            ...
            <div class="row">
                ...
                <div class="col-xl-12">
                    <div class="tp-postbox-details-thumb">
                        <img src="{{asset('public/frontend')}}/img/blog/details/blog-big-1.jpg" alt="">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-9 col-lg-8">
                    <div class="tp-postbox-details-main-wrapper">
                        <div class="tp-postbox-details-content">
                            <p class="tp-dropcap">sales process is critically important to the success of your reps and your
                                business. If you've never seen a really skilled salesperson work, it seems almost
                                effortless. They ask great questions, craftt perfect proposal, answer questions, address
                                concerns and seamlessly seal the Underneath the surface of all of that, the salesperson has
                                probably dedicated hours honing their craft and ensuring the process moves smoothly.</p>

                            <p>One of the challenges that often surfaces when working with a remote sales team is a lack of
                                transparency over what is happening, and where in the process things are taking place. We’re
                                going to peel back the curtain and show you how to create the best sales.</p>

                            <h4 class="tp-postbox-details-heading">Breaking Up With Fast Fashion Has Been Easier</h4>
                            <p>Lommodo ligula eget dolor. Aenean massa. Cum sociis que penatibus magnis dis parturient
                                montes lorem, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque euro,
                                pretium, sem. Nulla onsequat massa quis enim. donec pede justo fringilla vel aliquet.</p>

                            <div class="tp-postbox-details-desc-thumb text-center">
                                <img src="{{asset('public/frontend')}}/img/blog/details/blog-details-sm-1.jpg" alt="">
                                <span class="tp-postbox-details-desc-thumb-caption">Gucci’s Women’s Cruise Collection 2023
                                    Lookbook Has Arrived</span>
                            </div>
                            <p>“We’re so glad we’ll be working with you to get your new marketing strategy up and running.
                                I've attached the details of your package. Next you’ll get an email from Jen to schedule
                                your kick-off meeting and be assigned your account rep. During your kick-off meeting, we
                                will introduce your project team, let you know what access we need to start.” </p>

                            <div class="tp-postbox-details-quote">
                                <blockquote>
                                    <div class="tp-postbox-details-quote-shape">
                                        <img class="tp-postbox-details-quote-shape-1"
                                            src="{{asset('public/frontend')}}/img/blog/details/shape/line.png" alt="">
                                        <img class="tp-postbox-details-quote-shape-2"
                                            src="{{asset('public/frontend')}}/img/blog/details/shape/quote.png" alt="">
                                    </div>
                                    <p>There is a way out of every box, a solution to every puzzle its just a matter of
                                        finding it.</p>
                            ...
                            <p>Lorem ligula eget dolor. Aenean massa. Cum sociis que penatibus et magnis dis parturient
                                montes lorem,nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque euro,
                                pretium quis, sem. Nulla onsequat massa quis enim.</p>
                            ...
                            <p>Rhoncus ut, imperdiet a, venenatis vitae, justo. Nullam dictum felis eu pede mollis pretium.
                                Integer cidunt. Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend
                            ...
                            <div
                                ...
                                <div class="tp-postbox-details-navigation-item d-flex align-items-center">
                                    ...
                                    <div class="tp-postbox-details-navigation-content">
                                        ...
                                        <h3 class="tp-postbox-details-navigation-title">
                                            <a href="blog-details.html">Hiring the Right Sales Team at <br> the Right
                                                Time</a>
                                        </h3>
                                    </div>
                                </div>
                                <div class="tp-postbox-details-navigation-item d-flex align-items-center text-end">
                                    <div class="tp-postbox-details-navigation-content">
                                        <span>Next Post</span>
                                        <h3 class="tp-postbox-details-navigation-title">
                                            <a href="blog-details.html">Fully embrace the return of <br> 90s fashion</a>
                                        </h3>
                                    </div>
                            ...
                            <div class="tp-postbox-details-author d-sm-flex align-items-start" data-bg-color="#F4F7F9">
                                <div class="tp-postbox-details-author-thumb">
                                    <a href="#">
                                        <img src="{{asset('public/frontend')}}/img/users/user-11.jpg" alt="">
                                    </a>
                                </div>
                                <div class="tp-postbox-details-author-content">
                                    ...
                                    <p>By defining and following internal and external processes, your team will have
                                        clarity on resources to attract and retain customers for your business.</p>
                                ...
                                <div class="tp-postbox-details-comment-inner">
                                    <ul>
                                        <li>
                                                ...
                                                <div class="tp-postbox-details-comment-content">
                                                    <div
                                                        ...
                                                        <div class="tp-postbox-details-comment-avater">
                                                            <h4 class="tp-postbox-details-comment-avater-title">Lance Bogrol
                                                            </h4>
                                                            <span class="tp-postbox-details-avater-meta">12 April, 2023 at
                                                                3.50pm</span>
                                                        </div>
                                            ...
                                            <ul class="children">
                                                <li>
                                                    <div class="tp-postbox-details-comment-box d-sm-flex align-items-start">
                                                        <div class="tp-postbox-details-comment-thumb">
                                                            <img src="{{asset('public/frontend')}}/img/users/user-3.jpg" alt="">
                                                        </div>
                                                        <div class="tp-postbox-details-comment-content">
                                                            <div
                                                                class="tp-postbox-details-comment-top d-flex justify-content-between align-items-start">
                                                                <div class="tp-postbox-details-comment-avater">
                                                                    <h4 class="tp-postbox-details-comment-avater-title">Dasy
                                                                        Lily</h4>
                                        ...
                                        <li>
                                            <div class="tp-postbox-details-comment-box d-sm-flex align-items-start">
                                                <div class="tp-postbox-details-comment-thumb">
                                                    <img src="{{asset('public/frontend')}}/img/users/user-4.jpg" alt="">
                                                </div>
                                                <div class="tp-postbox-details-comment-content">
                                                    <div
                                                        class="tp-postbox-details-comment-top d-flex justify-content-between align-items-start">
                                                        <div class="tp-postbox-details-comment-avater">
                                                            <h4 class="tp-postbox-details-comment-avater-title">Shahnewaz
                                                                Sakil</h4>
                                                            <span class="tp-postbox-details-avater-meta">12 April, 2023 at
                                                                3.50pm</span>
                                                        </div>
                                ...
                                <div class="tp-sidebar-about">
                                    ...
                                    <div class="tp-sidebar-about-content">
                                        ...
                                        <div class="tp-sidebar-about-signature">
                                            <img src="{{asset('public/frontend')}}/img/blog/signature/signature.png" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="tp-sidebar-blog-item-wrapper">
                                    <div class="tp-sidebar-blog-item d-flex align-items-center">
                                        <div class="tp-sidebar-blog-thumb">
                                            <a href="blog-details.html">
                                                <img src="{{asset('public/frontend')}}/img/blog/sidebar/blog-sidebar-1.jpg" alt="">
                                            </a>
                                        </div>
                                    ...
                                    <div class="tp-sidebar-blog-item d-flex align-items-center">
                                        <div class="tp-sidebar-blog-thumb">
                                            <a href="blog-details.html">
                                                <img src="{{asset('public/frontend')}}/img/blog/sidebar/blog-sidebar-2.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="tp-sidebar-blog-content">
                                            <div class="tp-sidebar-blog-meta">
                                    ...
                                    <div class="tp-sidebar-blog-item d-flex align-items-center">
                                        <div class="tp-sidebar-blog-thumb">
                                            <a href="blog-details.html">
                                                <img src="{{asset('public/frontend')}}/img/blog/sidebar/blog-sidebar-3.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="tp-sidebar-blog-content">
                                            <div class="tp-sidebar-blog-meta">
