                ...
                <div class="row justify-content-md-center my-5">
                    <div class="col-md-9 col-lg-8 col-xl-6">
                        <div class="mw-510 block-center">
                            ...
                            <div class="text-decoration-lines"><span class="text-decoration-lines-content">or</span>
                            </div>
                            <!-- RD Mailform-->
                            <x-auth-session-status class="mb-4" :status="session('status')" />
                            <form method="POST" action="{{ route('login') }}" class="rd-form rd-mailform rd-form-centered">
                                @csrf
                                <div class="form-wrap">
