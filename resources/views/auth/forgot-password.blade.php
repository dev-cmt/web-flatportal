<x-frontend-layout :title="'Forgot'">
    ...
    <!-- login area start -->
    <section class="tp-login-area pt-40 pb-140 p-relative z-index-1 fix">
                                ...
                                <div class="tp-login-input-wrapper">
                                    <div class="tp-login-input-box">
                                        <div class="tp-login-input">
                                            <input type="email" name="email" id="email" value="{{old('email')}}" placeholder="your@gmail.com" required autofocus>
